...
<form method="POST" action="{{route('exportPaidInvoice')}}" id="frmExport" target="_blank">
    @csrf
...
<script>
    const currentUrl = "{{route('paidInvoiceReport')}}";
</script>
<script src="{{mix('js/reports/paid-invoice.js')}}"></script>
@endsection