...
use App\Http\Resources\Reports\GstResourceCollection;
...
class GstController extends Controller
{
    public function index()
    {
        ...
        $pageName = 'GST Report';
        return view('report_viewers.gst_report', compact('banks', 'engineers', 'deliveryBoys', 'pageName'));
    }
    ...
    public function show(Request $request): GstResourceCollection
    {
        ...
        GstResourceCollection::wrap('invoices');
        return GstResourceCollection::make($data);
    }
}
